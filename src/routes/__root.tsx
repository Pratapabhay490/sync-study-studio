...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A premium collaborative study tracker to sync MBBS progress, topic by topic." },
      { name: "theme-color", content: "#7c3aed" },
      { property: "og:title", content: "Let's be in sync — Collaborative MBBS study tracker" },
      { property: "og:description", content: "A premium collaborative study tracker to sync MBBS progress, topic by topic." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Let's be in sync — Collaborative MBBS study tracker" },
      { name: "twitter:description", content: "A premium collaborative study tracker to sync MBBS progress, topic by topic." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&family=Inter:wght@400;500;600;700&family=Nunito:wght@400;600;700&family=Instrument+Serif:ital@0;1&display=swap",
      },
    ],
  }),
