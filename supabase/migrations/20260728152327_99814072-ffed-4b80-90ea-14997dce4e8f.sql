...
REVOKE ALL ON FUNCTION public.start_focus_session(integer) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.start_focus_session(integer) TO authenticated;